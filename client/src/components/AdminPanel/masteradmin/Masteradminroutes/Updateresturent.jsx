  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 p-4">
      {restaurantData.map((restaurant) => (
        <div
          key={restaurant.id}
          className="h-[450px] w-[300px] bg-gray-800 rounded-lg shadow-lg overflow-hidden"
        >
          {/* Image Section */}
          <div
          ...
          <div className="p-4 flex flex-col justify-between h-[50%]">
            ...
            <div className="flex space-x-4">
              <button className="flex-1 bg-blue-500 text-white py-2 rounded-md hover:bg-blue-600 transition" onClick={(e)=>handleUpdateClick(restaurant)}>
                Update
              </button>
