...
const Cart = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-md mb-12">
      <h2 className="text-3xl font-bold text-gray-900 mb-6 border-b pb-4">Your Cart</h2>
      ...
      {items.length > 0 && (
        <div className="mt-8 border-t pt-4 flex flex-col md:flex-row md:justify-between items-center">
          <p className="text-2xl font-bold text-gray-900 mb-4 md:mb-0">Total: ₹{cartTotal}</p>
          <button
